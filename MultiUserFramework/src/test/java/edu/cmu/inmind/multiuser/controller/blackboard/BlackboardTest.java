...
public class BlackboardTest {
    ...
    public void testSetComponentsNoneSubscribed() throws Exception {
    ...
    @Test (expected = MultiuserException.class)
    public void testSetComponentsEmpty() throws Exception {
    ...
    @Test
    public void setKeepModel() throws Exception {
    ...
    @Test
    public void setNotifySubscribers() throws Exception {
    ...
    @Test
    public void isLoggerOn() throws Exception {
    ...
    @Test
    public void setLoggerOn() throws Exception {
    ...
    @Test (expected = MultiuserException.class)
    public void postWhenSenderNull() throws Exception {
    ...
    @Test (expected = MultiuserException.class)
    public void postWhenKeyNull() throws Exception {
    ...
    @Test (expected = MultiuserException.class)
    public void postWhenElementNull() throws Exception {
    ...
    @Test
    public void postWhenKeepModelOn () throws Exception {
    ...
    @Test
    public void postWhenKeepModelOff () throws Exception {
    ...
    @Test
    public void getWhenValidKey() throws Exception {
    ...
    @Test (expected = MultiuserException.class)
    public void getWhenNull() throws Exception {
        Session session = createDummySession();
        blackboard.setComponents(createComponents(), session.getId());
    ...
    @Test
    public void testSubscribeWithoutMessages() throws Exception {
    ...
    @Test
    public void testSubscribeWithMessages() throws Exception {
    ...
    @Test
    public void getSyncEvent() throws Exception {
        // TODO
    }
    ...
    @Test(expected = MultiuserException.class)
    public void testSubscribeWithExternalComponentNullMessages() throws Exception {
    ...
    @Test(expected = MultiuserException.class)
    public void testSubscribeWithExternalComponentNoMessages() throws Exception {
        ExternalComponent externalComponent = createExternalComponent(new String[]{});
        blackboard.subscribe(externalComponent);
    }

    @Test
    public void testSubscribeWithExternalComponent() throws Exception {
