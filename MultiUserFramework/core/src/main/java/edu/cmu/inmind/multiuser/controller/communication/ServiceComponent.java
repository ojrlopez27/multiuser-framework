...
public class ServiceComponent{
    private Class<? extends Pluggable> component;
    private String serviceURL;
    private ZMsgWrapper msgTemplate;
    private String[] subMessages;
    private ServiceInfo serviceInfo;

    public ServiceComponent(Class<? extends Pluggable> component, ServiceInfo serviceInfo, ZMsgWrapper msgTemplate) {
    ...
    public ServiceComponent setComponent(Class<? extends Pluggable> component) {
        if(  component == null ){
    ...
    public Class<? extends Pluggable> getComponent() {
        return component;
    }
